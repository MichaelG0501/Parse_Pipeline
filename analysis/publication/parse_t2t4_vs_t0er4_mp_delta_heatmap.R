####################
# parse_t2t4_vs_t0er4_mp_delta_heatmap.R
#
# Description:
#   Publication-quality heatmap showing the high-resolution NMF MP cluster
#   delta score changes (T2T4 vs T0eR4 per state).
#   Nature-contract figure style.
#
# Inputs:
#   parse_outs/cell_states/t2t4_vs_t0er4_highres_clusters/intermediate/parse_t2t4_vs_t0er4_ucell_scores.rds
#   parse_outs/cell_states/Auto_parse_PDOpipeline_topmp_assignments.rds
#
# Outputs:
#   parse_outs/publication/t2t4_vs_t0er4_mp_delta/figures/
#     t2t4_vs_t0er4_mp_delta_heatmap.pdf
#     t2t4_vs_t0er4_mp_delta_heatmap.png
#
# Methodology:
...
ucell_cache <- "cell_states/t2t4_vs_t0er4_highres_clusters/intermediate/parse_t2t4_vs_t0er4_ucell_scores.rds"
...
pdf_path <- file.path(fig_dir, "t2t4_vs_t0er4_mp_delta_heatmap.pdf")
png_path <- file.path(fig_dir, "t2t4_vs_t0er4_mp_delta_heatmap.png")
