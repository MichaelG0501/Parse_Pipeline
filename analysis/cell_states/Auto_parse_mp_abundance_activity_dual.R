####################
# Auto_parse_mp_abundance_activity_dual.R
#
# Add PDO-pipeline MP/state scoring and produce dual scATLAS/PDO abundance and
# activity plots for the 9 Parse/SUR1090 samples.
####################
