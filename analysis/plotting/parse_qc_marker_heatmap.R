####################
# parse_qc_marker_heatmap.R
#
# Description:
#   Builds raw and final Parse QC marker heatmaps using housekeeping and broad
#   lineage markers. This is a diagnostic/QC plotting script, not a downstream
#   analysis dependency.
#
# Inputs:
...
#   parse_outs/plots/Visualisation_and_Heatmaps/QC_prefilter.png
#   parse_outs/plots/Visualisation_and_Heatmaps/QC_final.png
#   parse_outs/plots/Visualisation_and_Heatmaps/QC_heatmaps.pdf
#   parse_outs/logs/run_summaries/parse_qc_marker_heatmap_*.txt
#
# Methodology:
#   analysis/methodology/plotting/qc_marker_heatmap_methodology.md
####################
...
script_path <- if (length(file_arg) > 0) {
  ...
  normalizePath(file.path(parse_project_root(), "analysis/plotting/parse_qc_marker_heatmap.R"))
}
...
sample_order <- c("PDO", parse_samples, "SUR1090_Treated", "SUR1090_Untreated")
