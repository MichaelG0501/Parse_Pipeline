####################
# parse_infercna_carroll_reference.R
#
# Description:
#   Runs InferCNA on the Parse/PDO/SUR1090 sample set using the Carroll_2023
#   scATLAS reference, then generates slide-scale CNA heatmaps and CNA scatter
#   summaries.
#
# Inputs:
...
#
# Outputs:
#   parse_outs/cnv/Auto_parse_infercna_outs_Carroll_2023.rds
#   parse_outs/cnv/Auto_parse_infercna_target_outs_Carroll_2023.rds
#   parse_outs/cnv/Auto_parse_cnv_heatmap_*_Carroll_2023.pdf
#   parse_outs/cnv/Auto_parse_cnv_scatter_Carroll_2023.pdf
#   parse_outs/logs/run_summaries/parse_infercna_carroll_reference_*.txt
#
# Cache / replot:
#   InferCNA matrix RDS files are reused if present. Heatmap input RDS files are
#   also saved next to each PDF so plot styling can be regenerated without
#   recomputing InferCNA.
#
# Methodology:
#   analysis/methodology/cnv/infercna_carroll_reference_methodology.md
####################
...
script_run <- parse_start_run(
  "parse_infercna_carroll_reference",
  parameters = list(reference_name = "Carroll_2023"),
  input_files = c(
    "parse_outs/by_samples/<sample>/Auto_<sample>_final.rds",
    parse_reference_paths$carroll_reference,
    parse_reference_paths$gene_order
  ),
  output_files = c(
    "parse_outs/cnv/Auto_parse_infercna_outs_Carroll_2023.rds",
    "parse_outs/cnv/Auto_parse_cnv_heatmap_all9_Carroll_2023.pdf",
    "parse_outs/cnv/Auto_parse_cnv_scatter_Carroll_2023.pdf"
  )
)
...
sample_order <- parse_all_samples

reference_name <- "Carroll_2023"
reference_path <- parse_reference_paths$carroll_reference
gene_order_path <- parse_reference_paths$gene_order
