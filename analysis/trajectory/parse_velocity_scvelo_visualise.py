#!/usr/bin/env python3
"""Visualise Parse RNA velocity with scVelo.

Inputs:
    parse_outs/Auto_velocity/looms/A/*.loom
    parse_outs/Auto_velocity/looms/B/*.loom
    parse_outs/Auto_velocity/tables/Auto_velocity_nonPDO_cell_metadata.csv

Outputs:
    parse_outs/Auto_velocity/Auto_scvelo_nonPDO.h5ad
    parse_outs/Auto_velocity/figures/Auto_velocity_*.png
    parse_outs/Auto_velocity/tables/Auto_scvelo_cell_metadata.csv

Cache / replot:
    Reuses loom files from velocyto. Plot-only changes can be regenerated by
    rerunning this script without repeating BAM filtering or velocyto.
...
from parse_pipeline_config import PARSE_SAMPLES, PROJECT_ROOT, VELOCITY_OUT  # noqa: E402
...
def add_centroid_label(ax: plt.Axes, center: np.ndarray, label: str, offset) -> None:
    text = ax.text(
        center[0] + offset[0],
        center[1] + offset[1],
        label,
