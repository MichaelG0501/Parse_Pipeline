...
# parse_pseudotime_sample_trajectory.R, or rebuilds it if assets are missing.
#
# Inputs:
...
#
# Outputs:
#   parse_outs/pseudotime_samples/Auto_parse_pseudotime_sample_linear_report.pdf
#   parse_outs/pseudotime_samples/Auto_parse_sample_pseudotime_projections.csv
#   parse_outs/logs/run_summaries/parse_pseudotime_linear_sample_report_*.txt
#
# Cache / replot:
#   Reuses cached trajectory assets unless missing, so plot styling can be
#   regenerated without rebuilding Monocle3.
#
# Methodology:
#   analysis/methodology/trajectory/pseudotime_linear_sample_report_methodology.md
####################

source("analysis/common/parse_pipeline_logging.R")

script_run <- parse_start_run(
  "parse_pseudotime_linear_sample_report",
  input_files = c(
    "parse_outs/pseudotime_samples/Auto_parse_sample_pseudotime_cds.rds",
    "parse_outs/pseudotime_samples/Auto_parse_sample_pseudotime.rds",
    "parse_outs/pseudotime_samples/Auto_parse_sample_pseudotime_metadata.csv"
