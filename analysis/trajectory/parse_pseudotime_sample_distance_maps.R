...
#
# Description:
#   Computes sample-to-sample pseudotime, graph, and UMAP distance matrices
#   from the cached T0-rooted Parse trajectory, then writes heatmap and
#   network-style T0-distance figures.
#
# Inputs:
...
#
# Outputs:
#   parse_outs/pseudotime_samples/sample_distance_pseudotime/Auto_parse_sample_distance_matrices.rds
#   parse_outs/pseudotime_samples/sample_distance_pseudotime/Auto_parse_sample_distance_long.csv
#   parse_outs/pseudotime_samples/sample_distance_pseudotime/Auto_parse_sample_distance_method_comparison_heatmap.pdf
#   parse_outs/pseudotime_samples/sample_distance_pseudotime/Auto_parse_sample_distance_from_T0_nodeplot.pdf
#   parse_outs/logs/run_summaries/parse_pseudotime_sample_distance_maps_*.txt
#
# Cache / replot:
#   Reuses cached trajectory assets and recalculates only lightweight distance
#   summaries and figures.
#
# Methodology:
#   analysis/methodology/trajectory/pseudotime_sample_distance_maps_methodology.md
####################

source("analysis/common/parse_pipeline_logging.R")

script_run <- parse_start_run(
  "parse_pseudotime_sample_distance_maps",
  input_files = c(
    "parse_outs/pseudotime_samples/Auto_parse_sample_pseudotime_cds.rds",
    "parse_outs/pseudotime_samples/Auto_parse_sample_pseudotime.rds",
    "parse_outs/pseudotime_samples/Auto_parse_sample_pseudotime_metadata.csv"
  ),
  output_files = "parse_outs/pseudotime_samples/sample_distance_pseudotime/*"
)
