####################
# Auto_parse_find_optimal_nmf.R
# Silhouette + WSS analysis to find optimal nMP for Parse metaprograms.
# Run after Auto_parse_geneNMF.R creates Metaprogrammes_Results/*.rds.
####################
...
script_path <- if (length(file_arg) > 0) {
  ...
  normalizePath("/rds/general/ephemeral/project/spatialtranscriptomics/ephemeral/Parse_Pipeline/analysis/metaprograms/Auto_parse_find_optimal_nmf.R")
}
