####################
# Auto_parse_mp_correlation_external.R
# Jaccard overlap and expression correlation of Parse MPs against scATLAS and PDO MPs.
####################
...
out_dir_root <- "/rds/general/project/spatialtranscriptomics/ephemeral/Parse_Pipeline/parse_outs"
setwd(out_dir_root)
...
# 2. scATLAS MPs
scatlas_geneNMF <- readRDS("/rds/general/project/tumourheterogeneity1/ephemeral/scRef_Pipeline/ref_outs/Metaprogrammes_Results/geneNMF_metaprograms_nMP_19.rds")
...
# 3. PDO MPs
pdo_geneNMF <- readRDS("/rds/general/project/tumourheterogeneity1/ephemeral/PDOs_Pipeline/PDOs_outs/Metaprogrammes_Results/geneNMF_metaprograms_nMP_13.rds")
