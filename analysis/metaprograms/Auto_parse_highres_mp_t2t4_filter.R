####################
# Auto_parse_highres_mp_t2t4_filter.R
#
# Alternative high-resolution Parse MP filtering.
# Uses the same nMP117 metaprograms/UCell scores as the strict trend analysis,
# but retains MPs where mean UCell activity in both T2 and T4 is higher than
# both T0 and eR4. Outputs are isolated in their own subfolder.
####################
