####################
# Auto_parse_mp_correlation.R
# Parse MP UCell correlation, self Jaccard overlap, and per-cell heatmap.
# Combined into a single PDF output.
####################
...
script_path <- if (length(file_arg) > 0) {
  ...
  normalizePath("/rds/general/user/sg3723/home/SPA_ephemeral/Parse_Pipeline/analysis/metaprograms/Auto_parse_mp_correlation.R")
}
